...
//            
    ...
    //plot(sqrt((x_pos_dcha(j)-x_pos2(j-1))^2 - (y_pos_dcha(j)-y_pos(j-1))^2),'or'); //sirve para ver la distancia real de los hilos
        ...
        //si la distancia se hace muy grande
//        if dist1(j-1)>150
//            //si es par
//            if modulo(j-1,2)==0
//            phi_objetivo(j)=0.0001;
//            theta_objetivo(j)=0.0001;
//        else
//            phi_objetivo(j)=-0.0001;
//            theta_objetivo(j)=-0.0001;
//        end
...
//            //si es par
//            if modulo(j-1,2)==0
//                phi_objetivo2(j)=0.0001;
//                theta_objetivo2(j)=0.0001;
//            else
//                phi_objetivo2(j)=-0.0001;
//                theta_objetivo2(j)=-0.0001;
//            end
//            
//        end
        //si la distancia entre catenarias es demasiado grande, me paro
//        if dist2(j)>150
//            phi_objetivo2(j)=0.0001;
//            theta_objetivo2(j)=0.0001;
//        end
...
//        if dist2(j-1)<90
//            if modulo(j-1,2)==0 //si es par
//                disp("entro");
//                phi_objetivo3(j)=0.0001;
//                theta_objetivo3(j)=0.0001;
//            else
//                phi_objetivo3(j)=-0.0001;
//                theta_objetivo3(j)=-0.0001;
//            end

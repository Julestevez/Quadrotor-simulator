...
function [z_acel, phi, angulotheta, psi, phi_vel, angulotheta_vel, psi_vel, Thrust] = quadrotor_izq(phi_ant, angulotheta_ant, psi_ant, phi_vel_ant, phi_vel_2ant, angulotheta_vel_ant, angulotheta_vel_2ant, psi_vel_ant, psi_vel_2ant, Ymax, catenary_load, z_vel_ant, z_vel_2ant, z_ant, TensH_A, TensH_B,theta_objetivo);           

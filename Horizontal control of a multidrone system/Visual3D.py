...
def Visual3D(theta, phi, x_pos, y_pos):
    ...
    #plot of the UAV
    X1=x_pos-20*math.cos(theta)
    X2=x_pos
    X3=x_pos+20*math.cos(theta)
    X4=x_pos
    
    Y1=y_pos
    Y2=y_pos-20*math.cos(phi)
    Y3=y_pos
    Y4=y_pos+20*math.cos(phi)
    

    Z1=50+20*math.sin(theta)
    Z2=50+20*math.sin(phi)
    Z3=50-20*math.sin(theta)
    Z4=50-20*math.sin(phi)
